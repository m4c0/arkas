...
export namespace atlas {
  ...
  [[nodiscard]] auto * plane_image() { return g_plane_image; }

  [[nodiscard]] const auto & ground_pc() { return g_gnd_plane_buffer->pc(); }
  [[nodiscard]] const auto & sky_pc() { return g_sky_plane_buffer->pc(); }
